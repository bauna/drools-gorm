 ...
 */
public class GormDroolsTransactionManager
    implements
    TransactionManager {

    private static final Logger logger = LoggerFactory.getLogger( GormDroolsTransactionManager.class );
    private PlatformTransactionManager ptm;

    private TransactionDefinition td = new DefaultTransactionDefinition();
    private TransactionStatus currentTransaction = null;

    public GormDroolsTransactionManager(PlatformTransactionManager ptm) {
        this.ptm = ptm;
    }
    ...
    public void registerTransactionSynchronization(TransactionSynchronization ts) {
        TransactionSynchronizationManager.registerSynchronization( new GormTransactionSynchronizationAdapter( ts ) );
    }
}
